...
import { render, cleanup, waitForElement, fireEvent, getByText, prettyDOM, getAllByTestId, getByAltText, getByPlaceholderText, waitForElementToBeRemoved, getByTestId, queryByText, queryByAltText, getByDisplayValue } from '@testing-library/react';
